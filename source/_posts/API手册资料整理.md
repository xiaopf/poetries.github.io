...
- [ECMA-262，第 5 版](http://javascript.ruanyifeng.com/)
...
- [Hemin在线版jquery 1.11.0手册，适合mac用户](http://hemin.cn/jq/)         
- [jquery 中文api](http://jquery.bootcss.com/)         
...
- [artTemplate -> tmodjs](https://github.com/aui/artTemplate)
...
- [artDialog 4.x](http://www.planeart.cn/demo/artDialog/)
...
- [requriejs 中文api 2.1.9](http://www.vipaq.com/rtfm/JavaScript/RequireJs/zh-cn/2.1.9/api.html)
- [requriejs 中文api 2.1.6](http://makingmobile.org/docs/tools/requirejs-api-zh/)
- [英文版各种API](http://devdocs.io/)
...
- [Node.js 资源汇总 - 无痕](https://github.com/mailzwj/node.js)
...
- [git-guid](http://rogerdudler.github.io/git-guide/index.zh.html )
- [justjavac](http://gitref.justjavac.com/ )
- [git-scm.com](http://git-scm.com/book/zh )
- [how-to-use-git-1-git-basic](http://gogojimmy.net/2012/01/17/how-to-use-git-1-git-basic/)
